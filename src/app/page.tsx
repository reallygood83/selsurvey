    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-purple-50">
      ...
      <main className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-2xl font-semibold text-gray-700 max-w-4xl mx-auto">
            SEL 감정분석 플랫폼
          </p>
          <p className="mt-8 text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            <span className="text-blue-600 font-semibold">교사는 학급의 감정 상태를 한눈에</span>, <span className="text-purple-600 font-semibold">학생들은 직관적인 인터페이스로</span><br/>
      ...
      <footer className="bg-gradient-to-r from-emerald-50 to-blue-50 border-t border-emerald-100">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-2">&copy; 2025 MindLog - SEL 감정분석 플랫폼 | 김문정(박달초). All rights reserved.</p>
